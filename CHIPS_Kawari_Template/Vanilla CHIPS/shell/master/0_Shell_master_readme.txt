IMPORTANT:
The illustrations provided are intended to be replaced. Please do not redistribute them without permission.

#--Master Shell

Hello! This is the place where you'll put all the visuals for your Ghost. This includes both their appearance and their right-click menu.

If you are familiar with Shell coding, then this will be very easy for you. If not, I'll point you to some helpful resources when it comes to SERIKO. SERIKO is the language Shells are coded in.
...
https://ssp.shillest.net/ukadoc/manual/descript_shell_surfaces.html is where to go if you'd like to do more complicated work. This page is the official documentation for SERIKO and should hold all the information you need. You can run it through a translator if you don't understand Japanese (which is understandable considering the audience for this template), but if it looks like too much for you, then that's OK. The Ashido walkthrough is a great point to go from, and you can do a lot with the info it gives you.
