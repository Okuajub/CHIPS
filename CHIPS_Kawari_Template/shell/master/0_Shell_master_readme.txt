...
profile (folder) - This is a folder that holds your specialized profile information, such as the position of the Ghost and its balloons. You don't need to do anything with it, except delete it before you publish your Ghost.

readme.txt - This is the readme for your shell. When someone installs a shell, this will pop up. For master shells, this is normally only seen when the user looks for it. Please remember to rewrite this, as I have placed my copyright notice inside it. Readmes a great place to put credit and notices of ownership, if someone else made your shell art or coding.
